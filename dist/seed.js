...
const seedData = async () => {
    try {
        ...
        await Wedding_1.default.deleteMany({});
        ...
        await ShoppingItem_1.default.deleteMany({});
        ...
        const defaultWedding = await Wedding_1.default.create({
        ...
        // 2. Create Users
        const webadminPasswordHash = await bcryptjs_1.default.hash('admin123', 10);
        const adminPasswordHash = await bcryptjs_1.default.hash('admin123', 10);
        const familyPasswordHash = await bcryptjs_1.default.hash('family123', 10);
        const volunteerPasswordHash = await bcryptjs_1.default.hash('volunteer123', 10);
        // Platform Super Admin
        const webadmin = await User_1.default.create({
        ...
        const family = await User_1.default.create({
            weddingId: defaultWedding._id,
            name: 'Kabir Ahmed',
        ...
        const volunteer = await User_1.default.create({
            weddingId: defaultWedding._id,
            name: 'Rahul Sharma',
        ...
        const mehendiEvent = await Event_1.default.create({
            weddingId: defaultWedding._id,
        ...
        const haldiEvent = await Event_1.default.create({
            weddingId: defaultWedding._id,
            name: 'Haldi Ceremony',
            date: haldiDate,
            themeColor: 'haldi',
        ...
        const nikahEvent = await Event_1.default.create({
            weddingId: defaultWedding._id,
        ...
        const receptionEvent = await Event_1.default.create({
            weddingId: defaultWedding._id,
        ...
        for (const g of guests) {
            await Guest_1.default.create(g);
        }
        ...
        for (const b of bookings) {
            await Booking_1.default.create(b);
        }
        ...
        for (const s of shoppingItems) {
            await ShoppingItem_1.default.create(s);
        }
